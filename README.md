...
Ubuntu 20.04 LTS via Vagrant in VirtualBox and compiled with GCC version 9.4.0
...
-   SimpleYour programs and functions will be compiled with gcc using the flags -Wall -Werror -Wextra and -pedantic
...
## Author
* **Roy Kiplagat** - [bagoviggo](https://github.com/bagoviggo)
